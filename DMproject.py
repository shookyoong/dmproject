...
def main():
    ...
    if st.button("Generate Plot"):
        ...
        st.title("Data Mining Project Member :")

        df2 = pd.DataFrame(np.array([['Chong Weng Hong', '1161200208', '1161200208@student.mmu.edu.my'],
                                     ['Teoh Zhen Hao', '1161201511', '1161201511@student.mmu.edu.my'],
                                     ['Lee Si Han', '1161200829', '1161200829@student.mmu.edu.my']]),
                           columns=['Name', 'Student ID', 'Email'])
        df2
